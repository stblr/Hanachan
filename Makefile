...
hanachan: bsp.o main.o mat34.o player.o quat.o rkg.o rkrd.o stats.o util.o vec3.o vec4.o wii.o yaz.o
	$(CC) $(CFLAGS) $^ -o $@ -lm

bsp.o: bsp.c bsp.h vec3.h util.h
main.o: main.c rkrd.h vec3.h util.h vec4.h player.h bsp.h rkg.h stats.h
mat34.o: mat34.c mat34.h vec3.h util.h vec4.h quat.h wii.h
player.o: player.c player.h bsp.h vec3.h util.h rkg.h stats.h vec4.h mat34.h quat.h wii.h
